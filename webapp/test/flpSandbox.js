		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Sap Fiori",
									"targetURL": "#comappsapfiori-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comappsapfiori-display": {
								"semanticObject": "comappsapfiori",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.app.sapfiori",
									"url": sap.ui.require.toUrl("com/app/sapfiori")
								}
							}
						}
					}
